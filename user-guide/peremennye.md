...
**Примечание:** обезжиренные переменные принимают все типы данных PHP, включая объекты и анонимные функции.
...
Чтобы удалить обезжиренную переменную из памяти, если она вам больше не нужна \(отбросьте ее, чтобы она не мешала другим вашим функциям / методам\), используйте этот метод:
...
* Установка обезжиренного эквивалента PHP global like `SESSION`также изменяет базовую версию PHP `$_SESSION`. Изменение последнего также изменяет аналог фреймворка.
