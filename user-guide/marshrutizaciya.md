...
Если вам нужно заменить маркеры подстановочных знаков в вашем маршруте \(т. е. `GET @complex:/resize/@format/*/sep/*)`, используйте числовой индекс, чтобы указать его новое значение, например: .
